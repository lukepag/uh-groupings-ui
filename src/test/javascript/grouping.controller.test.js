...
describe("GroupingController", () => {
    ...
    describe("existsInList", () => {
        ...
        it("should set $scope.membersInList to a comma-seperated string of members are in the list", () => {
            ...
            scope.existsInList("owner grouping", ["testOwnerGrouping"]);
    ...
    describe("addMembers", () => {
        ...
        it("should call displayAddModal when adding an owner grouping", () => {
            ...
            scope.addMembers("owner grouping", ["test-owner-path"])
    ...
    describe("returnMemberObject", () => {
        ...
        it("should find and return an owner grouping when searching for one", () => {
            scope.groupingName = "testOwnerGrouping";
            expect(scope.returnMemberObject("testOwnerGrouping", "owner grouping")).toEqual(scope.groupingOwners[1]);
        })
    });
